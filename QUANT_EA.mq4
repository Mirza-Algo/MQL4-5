...
//-----------------------BUYSTOP ORDER-------------------------------------------
   ...
   BuyTicket = OpenBuyStopOrder(Symbol(), LotSize, PendingPrice, BuyStopLoss, BuyTakeProfit, 0, MagicNumber, 0, "MUBASHIR MIRZA"); 
//----------------------SELLSTOP ORDER---------------------------------------------------
   ...
   SellTicket = OpenSellStopOrder(Symbol(), LotSize, PendingPrice, SellStopLoss, SellTakeProfit, 0, MagicNumber, 0, "MUBASHIR MIRZA"); 
//---
